...
const Navbar = () => {
  return (
    <div className='px-[200px] flex flex-wrap items-center h-[70px] bg-[#141420] text-white border-b-[2px] border-b-[#3B3B4A]'>
      <div>
        <label className='font-[800] text-[26px] font-["Poppins"] cursor-pointer'>LUPIN ALMTY</label>
      </div>
      <div className='ml-auto flex flex-wrap space-x-[96px] items-center text-[17px] font-[500] font-["Poppins"]'>
      ...
      <div className='flex flex-wrap ml-[143px] items-center space-x-[8px] h-[47px] border-[1px] border-[#BE50E5] rounded-[30px] px-[27px]'>
