...
const Navbar = () => {
  return (
    <div className='lg:pl-[200px] xl:pr-[200px] lg:pr-[100px] pb-[20px] lg:pb-0 bg-[#141420] text-white border-b-[2px] border-b-[#3B3B4A]'>
      <div className='flex flex-col space-y-[20px] lg:space-y-0 lg:flex-row lg:flex-wrap items-center lg:h-[70px]'>
        ...
        <div className='flex flex-wrap ml-[20px] xl:ml-[143px] items-center space-x-[8px] h-[47px] border-[1px] border-[#BE50E5] rounded-[30px] px-[27px]'>
          <div className='relative social-btn mr-[12px]'>
          ...
          <div className='relative social-btn ml-[12px]'>
            <i className='social-icon-circle'></i>
            <svg className="social-svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            width="28" height="28"
            viewBox="0 0 50 50"
