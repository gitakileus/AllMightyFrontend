...
export default function Landing() {
  ...
  return (
    <LandingLayout>
      ...
      <section className="flex flex-wrap flex-around bg-[#141420] md:px-[150px] lg:px-[200px] py-[92px] overflow-hidden">
        <div className="text-white w-50 z-[1] flex flex-col justify-center pl-8 md:px-0">
          <img
            ...
            alt="ethereum"
            className="w-[55px] h-[83px]"
          />
          <p className='font-[300] text-[40.2px] font-["Poppins"]'>
            MINT YOUR LUPIN
          </p>
        ...
        <div className="-translate-y-[10px] flex justify-center flex-1 w-50 mt-[100px] lg:mt-[30px]">
          <img
            ...
            alt="banner-border-image"
            className="absolute min-w-[381px] h-[351px]"
          />
          <div className="relative">
            <img
              src="/assets/images/banner-image.webp"
              alt="banner-image"
              className="min-w-[339px] h-[339px] z-10 translate-y-10"
            />
      ...
      <section className="bg-[#171725] px-[30px] md:px-[100px] lg:px-[200px] pb-[131px]">
        ...
        <div className="group flex justify-center items-center relative cursor-pointer mt-[64px] bg-[#212136] border-[#393965] border-[1px] rounded-[30px] overflow-hidden backdrop-opacity-0">
          <div className='text-[#CAA0FF] text-center px-[85px] pt-[43px] pb-[25px] font-[400] text-[18px] font-["Poppins"]'>
            <p>
              The Lupin Allmighty NFT is a collection of 3,333 generative images
              of our brands mascot Lupin Allmighty.
            </p>
            <p>
              ...
              users to win free items. Let’s see who can add Lupin to their
              collection.
            </p>
          </div>
                ...
                <div className="quote-wrapper overflow-hidden">
                  <blockquote className="text">
                    <p>
                      ...
                      <br /> <br />
                      gain access to the Lupin Almighty discord community, where
                ...
                <div className="quote-wrapper overflow-hidden">
                  <blockquote className="text">
                    <p>
                      ...
                      communicates with each other using Lupin.
                    </p>
                  </blockquote>
                </div>
                <p className='text-[#fff] font-[500] text-[26px] font-["Poppins"]'></p>
      ...
      >
        <div className="pt-[64px] text-center">
          <p className='text-[#BE50E5] font-[700] text-[40px] font-["Poppins"]'>
            The Team
          </p>
        </div>
      ...
      >
        <div className="pt-[93px]">
          <p className='text-center text-[#BE50E5] font-[700] font-["Poppins] text-[40px]'>
            FAQ
          </p>
        </div>
      ...
      <section className="bg-gradient-to-b from-[#141420] to-[#2B2B44] pt-[55px] pb-[88px] text-center">
        <div className="">
          <span className='font-["Poppins] font-[800] text-[49px] cursor-pointer text-[#fff] hover:text-[#aaa] duration-150'>
            LUPIN ALMTY
          </span>
        </div>
        <div className="flex justify-center">
          <div className="flex flex-wrap items-center space-x-[30px] h-[47px] relative ">
            ...
            <div className="relative social-btn !ml-0">
              <a href="https://discord.gg/VZNxcecXYk" target="_blank">
                <svg
            ...
            <div className="relative social-btn">
              <a href="https://twitter.com/themightylabel" target="_blank">
                <svg
                  className="social-svg"
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
