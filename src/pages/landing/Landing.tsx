    ...
    <LandingLayout>
      ...
      <section className='flex flex-wrap flex-around bg-[#141420] md:px-[150px] lg:px-[200px] py-[92px] overflow-hidden'>
        <div className='text-white w-50 z-[1] flex flex-col justify-center pl-8 md:px-0'>
            <img src='/assets/images/ethereum.webp' alt='ethereum' className='w-[55px] h-[83px]' />
            <p className='font-[300] text-[40.2px] font-["Poppins"]'>MINT YOUR LUPIN</p>
            ...
            <div className='gradient-border transition duration-500 ease-in-out rounded-[30px] hover:cursor-pointer border-[#BE50E5] border-[1px] w-fit mt-[31px]'>
              ...
              <div className='flex items-center mx-[25px] my-[15px]' onClick={activateBrowserWallet}>
                <img src='/assets/images/wallet.webp'className='w-[30px] h-[30px]'/>
        ...
        <div className='-translate-y-[10px] flex justify-center flex-1 w-50 mt-[100px] lg:mt-[30px]'>
          <img src='/assets/images/banner-border.webp' alt='banner-border-image' className='absolute min-w-[381px] h-[351px]'/>
          <div className='relative'>
            <img src='/assets/images/banner-image.webp' alt='banner-image' className='min-w-[339px] h-[339px] z-10 translate-y-10'/>
            ...
            <img src='/assets/images/bubble.webp' alt='bubble first' className='absolute animate-bounce transition-y-[100px] -right-[100px] bottom-[10px] w-[70px] h-[70px]'/>
            <img src='/assets/images/bubble.webp' alt='bubble second' className='absolute left-[20px] -bottom-[40px] w-[50px] h-[50px]'/>
            <img src='/assets/images/bubble.webp' alt='bubble third' className='absolute -left-[70px] top-[80px] w-[17px] h-[17px]'/>
            <img src='/assets/images/ring.webp' alt='rigng' className='absolute  -right-[70px] top-[0px] w-[55px] h-[55px]'/>
          </div>
        </div>
      </section>
      {/* collection section */}
      <section className='bg-[#171725] px-[30px] md:px-[100px] lg:px-[200px] pb-[131px]'>
      ...
      <section className='pt-[69px] pb-[150px] xl:pb-0 xl:-mb-[100px] pl-[73px] md:pl-[149px] lg:pl-[249px] xl:pl-[349px] pr-[73px] lg:pr-[173px] xl:pr-[273px] bg-[url("assets/images/roadmap-back.png")] bg-[#141420] .bg-opacity-25'>
        ...
        <div className="space-y-[100px] md:space-y-0 md:grid md:grid-cols-5 md:auto-rows-[1fr] mt-[150px] relative">
          ...
          <div className="row-start-1 row-span-2 col-start-1 col-span-2">
            ...
            <div className='absolute w-[82px] h-[82px] bg-[#fff] rounded-full bottom-0 md:bottom-auto left-1/2 md:left-auto md:top-1/2 -translate-x-1/2 translate-y-1/2 md:-translate-y-1/2 md:right-0 md:translate-x-1/2'>
              <div className='w-full h-full flex items-center justify-center'>
                <img src='assets/images/pen.webp' className='w-[54px] h-[54px]'/>
              </div>
            </div>
            </div>
          </div>
          ...
          <div className="hidden xl:block row-start-2 row-span-2 col-start-3 col-span-1">
            <img src='assets/images/line1.webp' className='w-full max-h-[258px]'/>
          </div>
          ...
          <div className="row-start-3 row-span-2 col-start-4 col-span-2">
            ...
            <div className='absolute w-[82px] h-[82px] bg-[#fff] rounded-full bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2'>
              <div className='w-full h-full flex items-center justify-center'>
                <img src='assets/images/broad.webp' className='max-w-[54px] max-h-[54px] w-full h-auto'/>
              </div>
            </div>
            </div>
          </div>
          ...
          <div className="hidden xl:block row-start-5 row-span-1 col-start-3 col-span-2">
            <img src='assets/images/line2.webp' className='w-full max-h-[240px] -mt-[220px]'/>
          </div>
          ...
          <div className="row-start-5 row-span-2  col-start-1 col-span-2">
            ...
            <div className='absolute w-[82px] h-[82px] bg-[#fff] rounded-full  bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2'>
              <div className='w-full h-full flex items-center justify-center'>
                <img src='assets/images/file.webp' className='w-[54px] h-[54px]'/>
              </div>
            </div>
            </div>
          </div>
          ...
          <div className="hidden xl:block row-start-7 row-span-2 col-start-2 col-span-2">
            <img src='assets/images/line3.webp' className='w-full max-h-[355px] -mt-[190px]'/>
          </div>
          ...
          <div className="row-start-7 xl:row-start-[8] row-span-2 col-start-4 col-span-2">
            ...
            <div className='absolute w-[82px] h-[82px] bg-[#fff] rounded-full bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2'>
              <div className='w-full h-full flex items-center justify-center'>
                <img src='assets/images/voice.webp' className='max-w-[54px] max-h-[54px] w-full h-auto'/>
              </div>
            </div>
            </div>
          </div>
      ...
      <section className='bg-gradient-to-b from-[#141420] to-[#2B2B44] pt-[55px] pb-[88px] text-center'>
        <div className=''>
          <span className='font-["Poppins] font-[800] text-[49px] cursor-pointer text-[#fff] hover:text-[#aaa] duration-150'>LUPIN ALMTY</span>
        </div>
        <div className='flex justify-center'>
          <div className='flex flex-wrap items-center space-x-[30px] h-[47px] relative '>
            <i className='social-icon-circle mx-0'></i>
            <div className='relative social-btn !ml-0'>
              <svg className="social-svg" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="26px" height="26px" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="white" d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515a.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0a12.64 12.64 0 0 0-.617-1.25a.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057a19.9 19.9 0 0 0 5.993 3.03a.078.078 0 0 0 .084-.028a14.09 14.09 0 0 0 1.226-1.994a.076.076 0 0 0-.041-.106a13.107 13.107 0 0 1-1.872-.892a.077.077 0 0 1-.008-.128a10.2 10.2 0 0 0 .372-.292a.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127a12.299 12.299 0 0 1-1.873.892a.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028a19.839 19.839 0 0 0 6.002-3.03a.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419c0-1.333.956-2.419 2.157-2.419c1.21 0 2.176 1.096 2.157 2.42c0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419c0-1.333.955-2.419 2.157-2.419c1.21 0 2.176 1.096 2.157 2.42c0 1.333-.946 2.418-2.157 2.418Z"/></svg>
            </div>
            <div className='relative social-btn rounded-full bg-white p-[2px]'>
              <svg className="social-svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                width="26" height="26"
                viewBox="0 0 50 50"
                style={{"fill":"#000"}}><path d="M 16 3 C 8.8324839 3 3 8.8324839 3 16 L 3 34 C 3 41.167516 8.8324839 47 16 47 L 34 47 C 41.167516 47 47 41.167516 47 34 L 47 16 C 47 8.8324839 41.167516 3 34 3 L 16 3 z M 16 5 L 34 5 C 40.086484 5 45 9.9135161 45 16 L 45 34 C 45 40.086484 40.086484 45 34 45 L 16 45 C 9.9135161 45 5 40.086484 5 34 L 5 16 C 5 9.9135161 9.9135161 5 16 5 z M 37 11 A 2 2 0 0 0 35 13 A 2 2 0 0 0 37 15 A 2 2 0 0 0 39 13 A 2 2 0 0 0 37 11 z M 25 14 C 18.936712 14 14 18.936712 14 25 C 14 31.063288 18.936712 36 25 36 C 31.063288 36 36 31.063288 36 25 C 36 18.936712 31.063288 14 25 14 z M 25 16 C 29.982407 16 34 20.017593 34 25 C 34 29.982407 29.982407 34 25 34 C 20.017593 34 16 29.982407 16 25 C 16 20.017593 20.017593 16 25 16 z"></path></svg>
            </div>
        ...
        <div className='mt-[16.4px]'>
            <p className='font-[300] font-["Poppins"] text-[16px] text-[#fff] cursor-pointer'>© LUPIN ALMTY2022</p>
        </div>
      </section>
    </LandingLayout>
  );
