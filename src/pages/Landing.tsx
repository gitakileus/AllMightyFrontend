    ...
    <MintingLayout>
      ...
      <section className='flex flex-wrap flex-around bg-[#141420] px-[150px] lg:px-[200px] py-[92px] overflow-hidden'>
        ...
        <div className='-translate-y-[10px] flex justify-center flex-1 w-50 mt-[100px] lg:mt-[30px]'>
          <img src='/assets/image/banner-border.webp' alt='banner-border-image' className='absolute min-w-[381px] h-[351px]'/>
          <div className='relative'>
            <img src='/assets/image/banner-image.webp' alt='banner-image' className='min-w-[339px] h-[339px] z-10 translate-y-10'/>
